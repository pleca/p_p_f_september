...
$adres_http_umowy = 'https://'.$_SERVER ['HTTP_HOST'].'/wzory_dokumentow/pouczenia/pouczenie_o_prawie_do_odstapienia_od_umowy';
...
if (!$pdf->saveAs('/var/www/pliki/!sprawy/'.$id_sprawy.'/'.$id_sprawy.'_pouczenie_o_prawie_odstapienia_od_umowy.pdf')) {
