...
$oswiadczenie_uprawnionego = json_decode($_POST['oswiadczenie_uprawnionego'], true);
$stosunki_rodzinne = json_decode($_POST['stosunki_rodzinne'], true);
$sytuacja_po_smierci = json_decode($_POST['sytuacja_po_smierci'], true);
$oswiadczenie = json_decode($_POST['oswiadczenie'], true);
...
<script id="skrypty" type="text/javascript" src="<?php echo 'https://' . $_SERVER ['HTTP_HOST'] . '/moduly/druki/wzory_dokumentow/js/wzory_dokumentow.js'; ?>"></script>
    ...
    <div class="pdf_strona">
        ...
        <div class="pdf_szara_kratka pdf_kratka_duza kratka_naglowek">
            ...
            <div class="form-group col-md-12 margin_b_0">
                ...
                <p class="col-md-12 margin_t_0">
                    <span class="glyphicon glyphicon<?php echo ($oswiadczenie_uprawnionego['PogorszenieSytuacjiZyciowej'] == 1) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> pogorszenia sytuacji życiowej w sferze materialnej,
                    <span class="glyphicon glyphicon<?php echo ($oswiadczenie_uprawnionego['WystapienieKrzywdy'] == 1) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> wystąpienia krzywdy w związku ze śmiercią członka najbliższej rodziny.
                </p>
            </div>
        </div>
        ...
        <div class="pdf_szara_kratka pdf_kratka_duza kratka_naglowek">
            ...
            <div class="form-group col-md-12 margin_b_0">
                <p class="col-md-12 margin_t_10">Zmarły/-a w momencie śmierci miał/-a <?php echo $oswiadczenie_uprawnionego['WiekZmWMomencieSmierci']; ?> lat. Wykształcenie:
                    <span class="glyphicon glyphicon<?php echo ($poszkodowany['Wyksztalcenie'] == 1) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> podstawowe /
                    <span class="glyphicon glyphicon<?php echo ($poszkodowany['Wyksztalcenie'] == 2) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> zawodowe /
                    <span class="glyphicon glyphicon<?php echo ($poszkodowany['Wyksztalcenie'] == 3) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> średnie /
                    <span class="glyphicon glyphicon<?php echo ($poszkodowany['Wyksztalcenie'] == 4) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> wyższe.
                </p>
                <p class="col-md-12 ">Zawód wyuczony <?php echo $poszkodowany['ZawodWyuczony']; ?> zawód wykonywany <?php echo $poszkodowany['ZawodWykonywany']; ?>.
                <p class="col-md-12 ">Dodatkowe kwalifikacje lub uprawnienia <?php echo $poszkodowany['DodatkoweUprawnienia']; ?>.
                <p class="col-md-12 ">Zatrudnienie:
                    <span class="glyphicon glyphicon<?php echo ($poszkodowany['Zatrudnienie'] == 1) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> brak /
                    <span class="glyphicon glyphicon<?php echo ($poszkodowany['Zatrudnienie'] == 2) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> umowa o pracę /
                    <span class="glyphicon glyphicon<?php echo ($poszkodowany['Zatrudnienie'] == 3) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> umowa zlecenia /
                    <span class="glyphicon glyphicon<?php echo ($poszkodowany['Zatrudnienie'] == 4) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> własna działalność gospodarcza /
                    <span class="glyphicon glyphicon<?php echo ($poszkodowany['Zatrudnienie'] == 5) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> gospodarstwo rolne /
                    <span class="glyphicon glyphicon<?php echo ($poszkodowany['Zatrudnienie'] == 6) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> prace dorywcze /
                    <span class="glyphicon glyphicon<?php echo ($poszkodowany['Zatrudnienie'] == 7) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> inne <?php echo $poszkodowany['ZatrudnienieInne']; ?>
                </p>
                <p class="col-md-12 ">Przeciętne miesięczne zarobki zmarłego w okresie trzech miesięcy przed wypadkiem według mojej wiedzy wynosiły około <?php echo $poszkodowany['Zarobki']; ?> zł netto.
            </div>
        </div>
        ...
        <div class="pdf_szara_kratka pdf_kratka_duza kratka_naglowek">
            ...
            <div class="form-group col-md-12 margin_b_0">
                <p class="col-md-12 margin_t_10">W momencie śmierci zmarłego/-ej miałem/am <?php echo $oswiadczenie_uprawnionego['WiekUprWMomencieSmierci']; ?> lat. Wykształcenie:
                    <span class="glyphicon glyphicon<?php echo ($uprawniony['Wyksztalcenie'] == 1) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> podstawowe /
                    <span class="glyphicon glyphicon<?php echo ($uprawniony['Wyksztalcenie'] == 2) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> zawodowe /
                    <span class="glyphicon glyphicon<?php echo ($uprawniony['Wyksztalcenie'] == 3) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> średnie /
                    <span class="glyphicon glyphicon<?php echo ($uprawniony['Wyksztalcenie'] == 4) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> wyższe.
                </p>
                <p class="col-md-12 ">Zawód wyuczony <?php echo $uprawniony['ZawodWyuczony']; ?> zawód wykonywany <?php echo $uprawniony['ZawodWykonywany']; ?>.
                <p class="col-md-12 ">Dodatkowe kwalifikacje lub uprawnienia <?php echo $uprawniony['DodatkoweUprawnienia']; ?>.
                <p class="col-md-12 ">Zatrudnienie:
                    <span class="glyphicon glyphicon<?php echo ($uprawniony['Zatrudnienie'] == 1) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> brak /
                    <span class="glyphicon glyphicon<?php echo ($uprawniony['Zatrudnienie'] == 2) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> umowa o pracę /
                    <span class="glyphicon glyphicon<?php echo ($uprawniony['Zatrudnienie'] == 3) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> umowa zlecenia /
                    <span class="glyphicon glyphicon<?php echo ($uprawniony['Zatrudnienie'] == 4) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> własna działalność gospodarcza /
                    <span class="glyphicon glyphicon<?php echo ($uprawniony['Zatrudnienie'] == 5) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> gospodarstwo rolne /
                    <span class="glyphicon glyphicon<?php echo ($uprawniony['Zatrudnienie'] == 6) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> prace dorywcze /
                    <span class="glyphicon glyphicon<?php echo ($uprawniony['Zatrudnienie'] == 7) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> inne <?php echo $uprawniony['ZatrudnienieInne']; ?>
                </p>
                <p class="col-md-12 ">Moje miesięczne zarobki w okresie ostatnich trzech miesięcy wynosiły średnio <?php echo $uprawniony['Zarobki']; ?> zł netto.
            </div>
        </div>
        ...
        <div class="pdf_szara_kratka pdf_kratka_duza kratka_naglowek">
            ...
            <div class="form-group col-md-12 margin_b_0">
                <p class="col-md-12 margin_t_10">Zmarły/-a był/-a dla mnie:
                    <span class="glyphicon glyphicon<?php echo ($stosunki_rodzinne['PokrewienstwoZeZmarlym'] == 1) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> mężem / żoną /
                    <span class="glyphicon glyphicon<?php echo ($stosunki_rodzinne['PokrewienstwoZeZmarlym'] == 2) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> partnerem / partnerką /
                    <span class="glyphicon glyphicon<?php echo ($stosunki_rodzinne['PokrewienstwoZeZmarlym'] == 3) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> ojcem / matką /
                    <span class="glyphicon glyphicon<?php echo ($stosunki_rodzinne['PokrewienstwoZeZmarlym'] == 4) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> synem / córką /
                    <span class="glyphicon glyphicon<?php echo ($stosunki_rodzinne['PokrewienstwoZeZmarlym'] == 5) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> bratem / siostrą /
                    <span class="glyphicon glyphicon<?php echo ($stosunki_rodzinne['PokrewienstwoZeZmarlym'] == 6) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> wnukiem / wnuczką /
                    <span class="glyphicon glyphicon<?php echo ($stosunki_rodzinne['PokrewienstwoZeZmarlym'] == 7) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> dziadkiem / babcią /
                    <span class="glyphicon glyphicon<?php echo ($stosunki_rodzinne['PokrewienstwoZeZmarlym'] == 8) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> inne <?php echo $stosunki_rodzinne['PokrewienstwoInneZeZmarlym']; ?>
                </p>

                <p class="col-md-12 margin_b_0">Zmarły/-a
                    <span class="glyphicon glyphicon<?php echo ($stosunki_rodzinne['WspolneGospodarstwo'] == 1) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> pozostawał/-a ze mną we wspólnym gospodarstwie domowym,
                </p>
                <p class="col-md-12 margin_t_0 margin_l_65">
                    <span class="glyphicon glyphicon<?php echo ($stosunki_rodzinne['TenSamAdres'] == 1) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> był/-a zameldowany/-a ze mną pod jednym adresem,
                </p>
                <p class="col-md-12 margin_t_0 margin_l_65">
                    <span class="glyphicon glyphicon<?php echo ($stosunki_rodzinne['InnyAdres'] == 1) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> nie był/-a zameldowany/-a ze mną pod jednym adresem, ale faktycznie zamieszkiwaliśmy razem,
                </p>
                <p class="col-md-12 margin_t_0 margin_l_65">
                    <span class="glyphicon glyphicon<?php echo ($stosunki_rodzinne['PomagalWObowiazkach'] == 1) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> pomagał w bieżących obowiązkach związanych z prowadzeniem gospodarstwa domowego,
                </p>
                <p class="col-md-12 margin_t_0 margin_l_65">
                    <span class="glyphicon glyphicon<?php echo ($stosunki_rodzinne['PomagalWObowiazkach'] == 2) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> nie pomagał w bieżących obowiązkach związanych z prowadzeniem gospodarstwa domowego.
                </p>

                <p class="col-md-12">Moje stosunki ze zmarłym/-ą określam jako:
                    <span class="glyphicon glyphicon<?php echo ($stosunki_rodzinne['StosunkiZeZmarlym'] == 1) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> bardzo zażyłe /
                    <span class="glyphicon glyphicon<?php echo ($stosunki_rodzinne['StosunkiZeZmarlym'] == 2) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> zażyłe /
                    <span class="glyphicon glyphicon<?php echo ($stosunki_rodzinne['StosunkiZeZmarlym'] == 3) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> powierzchowne /
                    <span class="glyphicon glyphicon<?php echo ($stosunki_rodzinne['StosunkiZeZmarlym'] == 4) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> złe.
                </p>

                <p class="col-md-12 margin_b_0">Zmarły/-a
                    <span class="glyphicon glyphicon<?php echo ($stosunki_rodzinne['BylNaUtrzymaniu'] == 1) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> był/-a na moim utrzymaniu /
                    <span class="glyphicon glyphicon<?php echo ($stosunki_rodzinne['LozylNaUtrzymanie'] == 1) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> łożył/-a na moje utrzymanie,
                    <span class="glyphicon glyphicon<?php echo ($stosunki_rodzinne['WspolneKonto'] == 1) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> posiadał/-a ze mną wspólne konto,
                </p>
                <p class="col-md-12 margin_t_0 margin_l_65">
                    <span class="glyphicon glyphicon<?php echo ($stosunki_rodzinne['PartycypowalKoszty'] == 1) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> partycypował/-a w kosztach utrzymania rodziny,
                </p>
                <p class="col-md-12 margin_t_0 margin_l_65">
                    <span class="glyphicon glyphicon<?php echo ($stosunki_rodzinne['WspieralbyFinansowo'] == 1) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> według mojej oceny w przyszłości wspierałby/-aby mnie finansowo w razie potrzeby.
                </p>
            </div>
        </div>
        ...
        <div class="pdf_szara_kratka pdf_kratka_duza kratka_naglowek">
            ...
            <div class="form-group col-md-12 margin_b_0">
                ...
                <p class="col-md-12 margin_t_0">
                    <span class="glyphicon glyphicon<?php echo ($sytuacja_po_smierci['SytuacjaMaterialna'] == 1) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> nie uległa zmianie /
                    <span class="glyphicon glyphicon<?php echo ($sytuacja_po_smierci['SytuacjaMaterialna'] == 2) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> pogorszyła się nieznacznie /
                    <span class="glyphicon glyphicon<?php echo ($sytuacja_po_smierci['SytuacjaMaterialna'] == 3) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> pogorszyła się znacznie.
                </p>
                <p class="col-md-12 ">Moja motywacja do poprawy własnej sytuacji materialnej
                    <span class="glyphicon glyphicon<?php echo ($sytuacja_po_smierci['MotywacjaUprawnionego'] == 1) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> nie uległa zmianie /
                    <span class="glyphicon glyphicon<?php echo ($sytuacja_po_smierci['MotywacjaUprawnionego'] == 2) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> poprawiła się /
                    <span class="glyphicon glyphicon<?php echo ($sytuacja_po_smierci['MotywacjaUprawnionego'] == 3) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> pogorszyła się.
                </p>

                <p class="col-md-12 margin_b_0">Po śmierci członka najbliższej rodziny:</p>
                <p class="col-md-12 margin_t_0 margin_b_0 margin_l_10">
                    <span class="glyphicon glyphicon<?php echo ($sytuacja_po_smierci['WstrzasPsychiczny'] == 1) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> odczułem/-am /
                    <span class="glyphicon glyphicon<?php echo ($sytuacja_po_smierci['WstrzasPsychiczny'] == 2) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> nie odczułem/-am znacznego wstrząsu psychicznego,
                </p>
                <p class="col-md-12 margin_t_0 margin_b_0 margin_l_10">
                    <span class="glyphicon glyphicon<?php echo ($sytuacja_po_smierci['KorzystalZeSrodkow'] == 1) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> korzystałem/-am ze środków farmakologicznych/ziołowych w związku ze złym stanem psychicznym /
                    <span class="glyphicon glyphicon<?php echo ($sytuacja_po_smierci['StanUleglPogorszeniu'] == 1) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> stan mojego zdrowia uległ pogorszeniu,
                </p>
                <p class="col-md-12 margin_t_0 margin_l_10">
                    <span class="glyphicon glyphicon<?php echo ($sytuacja_po_smierci['KorzystalZPorad'] == 1) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> korzystałem/-am z porad/wsparcia psychiatry, psychologa, pedagoga szkolnego, lekarza pierwszego kontaktu, duchownego, rodziny
                </p>
            </div>
            <p class="col-md-12 margin_t_10 margin_b_0">Zmarły/-a pozostawił/-a po sobie
                <span class="glyphicon glyphicon<?php echo ($sytuacja_po_smierci['Wdowa'] == 1) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> wdowę/wdowca
                <span class="glyphicon glyphicon<?php echo ($sytuacja_po_smierci['Dzieci'] == 1) ? '-check' : '-unchecked' ; ?>" aria-hidden="true"></span> dzieci, ile <?php echo $sytuacja_po_smierci['LiczbaDzieci']; ?> w wieku <?php echo $sytuacja_po_smierci['WiekDzieci']; ?>.
            </p>
        </div>
    ...
    <div class="pdf_szara_kratka pdf_kratka_duza kratka_naglowek height_1200">
        ...
        <div class="pdf_podpisy col-md-12 paddding_l_0 paddding_r_0 margin_t_60 margin_b_20">
            ...
            <div class="pdf_podpisy_p float_r col-md-4 paddding_l_0 paddding_r_10">
                <?php echo $oswiadczenie['Miejscowosc'].' '.$oswiadczenie['Data']; ?>
                <div class="pdf_kreska col-md-12 paddding_l_0 paddding_r_0 margin_b_0"></div>
