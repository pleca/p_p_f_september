...
<?php 
	...
	$identyfikator_przedstawiciela = $umowa['numer_agenta'];
...
podmiotu (zwanego dalej zobowiązanym) ponoszącego odpowiedzialność cywilną w związku z wypadkiem z dnia <span class="pogrubienie"><?php echo $data_wypadku; ?></span>
			i uzyskanie od zobowiązanego świadczeń odszkodowawczych za szkodę na osobie należnych Zleceniodawcy.
		</p></div>
	</div>
    <div class="sekcja">
		...
		<div class="sekcja_tresc"><p>
			Umowa zostaje zawarta na czas do całkowitego wyegzekwowania dla Zleceniodawcy świadczeń należnych od zobowiązanego <span class="pogrubienie">w postępowaniu przedsądowym, sądowym i egzekucyjnym.</span>
		</p></div>
	</div>
    <div class="sekcja">
		...
		<div class="sekcja_tresc"><p>
			1. Skierowanie sprawy na drogę postępowania sądowego przeciwko zobowiązanemu wymaga zgody obu stron umowy.</p>
            <p>
...
i oświadczeń, które będą przydatne do wykonania umowy.</p>
            <p>
			3. <span class="pogrubienie">Koszty wynagrodzenia pełnomocnika procesowego</span>, o którym mowa w § 9 ust. 1, w tym konieczne koszty zastępstwa substytucyjnego,
obciążają VOTUM.</p>
            <p>
			4. <span class="pogrubienie">VOTUM zobowiązuje się do wystąpienia o zwolnienie Zleceniodawcy z kosztów sądowych</span>, po uprzednim złożeniu przez
Zleceniodawcę oświadczenia o stanie rodzinnym, majątku i dochodach, wg wzoru urzędowego.</p>
            <p>
			5. <span class="pogrubienie">Koszty sądowe ponosi VOTUM</span>, jeżeli sąd nie zwolni od ich ponoszenia Zleceniodawcy na podstawie wniosku, o którym mowa w ust. 4.<p>
			6. Koszty procesu zasądzone od zobowiązanego przypadają VOTUM, z tym, że koszty zastępstwa procesowego zasądzone w sprawie
przypadają pełnomocnikowi procesowemu, o którym mowa w § 9 ust. 1.</p>
        </div>
	</div>
...
<div class="strona_znak_wodny"><?php echo $znak_wodny; ?></div>
	<div class="sekcja">
		...
		<div class="sekcja_tresc"><p>
            <span class="pogrubienie">VOTUM ponosi koszty wynagrodzenia pełnomocnika procesowego</span>, o którym mowa w § 9 ust. 2, reprezentującego Zleceniodawcę
            jako pokrzywdzonego <span class="pogrubienie">w karnym postępowaniu przygotowawczym prowadzonym</span> w związku z wypadkiem wskazanym w § 1.</p>
            <p>Wynagrodzenie pełnomocnika, które obciąża VOTUM obejmuje:</p>
            <p>
			1) przystąpienie do sprawy w charakterze pełnomocnika pokrzywdzonego w postępowaniu przygotowawczym,</p>
            <p>
			2) wystąpienie o dokumentację niezbędną do realizacji niniejszej umowy,</p>
            <p>
			3) sporządzanie pism procesowych.</p>
        </div>
	</div>
	
	<div class="sekcja">
		<div class="sekcja_tytul">REPREZENTACJA W POSTĘPOWANIU PRZED SĄDEM RODZINNYM</div>
		<div class="sekcja_paragraf">§ 5</div>
		<div class="sekcja_tresc"><p>
			Na wniosek Zleceniodawcy, w przypadku, gdy dla realizacji niniejszej umowy niezbędne jest uzyskanie orzeczenia sądu dotyczącego
ubezwłasnowolnienia, ustanowienia opieki lub kurateli, za zgodą obu stron umowy,<span class="pogrubienie">Votum poniesie koszty wynagrodzenia
...
nie dotyczy skierowania sprawy na drogę postępowania sądowego, o którym mowa w § 3 umowy.
		</p></div>
	</div>
	...
	<div class="sekcja">
		...
		<div class="sekcja_tresc">
			<p>
			1. W przypadku, gdy ustalenia postępowania karnego prowadzonego w sprawie wypadku, o którym mowa w § 1, ograniczają lub
...
lub przygotowania autorskiej opinii w przedmiocie przebiegu wypadku i prawidłowości zachowań jego uczestników.
			</p>
			<p>
				2. Koszty analizy oraz opinii, o których mowa w ust. 1 ponosi VOTUM, której na mocy odrębnej umowy z ekspertem, będą przysługiwały
do nich autorskie prawa majątkowe.
			</p>
			<p>
				3. Udostępnianie, rozpowszechnianie, a także obrót dokumentami, o których mowa w niniejszym paragrafie są możliwe wyłącznie za
pisemną zgodą VOTUM.
			</p>
		</div>
	</div>
    <div class="sekcja">
		<div class="sekcja_tytul">REHABILITACJA</div>
		<div class="sekcja_paragraf">§ 7</div>
		<div class="sekcja_tresc">
			<p>
			1. Za zgodą obu stron, VOTUM przekaże Polskiemu Centrum Rehabilitacji Funkcjonalnej VOTUM dokumentację medyczną dostarczoną
przez Zleceniodawcę oraz zgromadzoną w trakcie trwania niniejszej umowy, celem przygotowania oferty indywidualnego programu
rehabilitacji zawierającego wymiar godzinowy i zestawienie konsultacji oraz zabiegów niezbędnych w procesie leczenia. W skład
programu mogą wchodzić, w zależności od oceny stanu zdrowia Zleceniodawcy, m.in.: rehabilitacja, konsultacje wielospecjalistyczne,
np. konsultacja lekarza neurologa, neurochirurga, anestezjologa, radiologa oraz ortopedy, termolezja, ostrzykiwanie toksyną
botulinową, orthokine, w tym zabiegi, które nie są refundowane przez NFZ.
			</p>
			<p>
			2. Za zgodą obu stron, VOTUM może udzielić zaliczki na pokrycie kosztów przeprowadzenia rehabilitacji, zgodnie z programem,
o którym mowa w ust. 1.
			</p>
			<p>
			3. VOTUM zobowiązuje się do dochodzenia zwrotu kosztów indywidualnego planu rehabilitacji, a w przypadku, gdy podmiot
zobowiązany odmówi ich zaspokojenia w całości lub w części, Zleceniodawca wyraża zgodę na ich dochodzenie na drodze sądowej.
			</p>
		</div>
	</div>
    <div class="sekcja">
		...
		<div class="sekcja_tresc">
			<p>
			W przypadku, gdy ocena okoliczności sprawy wskazuje na istnienie odpowiedzialności po stronie zobowiązanego (w szczególności, jeśli
Zleceniodawca był pasażerem lub jest osobą małoletnią poniżej 13-ego roku życia) lub też została ona przez niego przyjęta, VOTUM, na
wniosek Zleceniodawcy, może udzielić mu zaliczki pieniężnej na poczet przyszłych świadczeń.
			</p>
		</div>
	</div>
...
adwokatów lub radców prawnych, przy czym za działanie tych osób VOTUM odpowiada wobec Zleceniodawcy jak za działania własne.
        ...
        <p>
		2. Zleceniodawca upoważnia VOTUM do pozyskiwania informacji o jego stanie zdrowia w zakresie, w jakim jest to niezbędne do
wykonania umowy.</p>
        <p>
		3. VOTUM oświadcza, że nie zawrze z zobowiązanym ugody w imieniu Zleceniodawcy bez jego uprzedniej zgody. Wyrażenie zgody
może nastąpić w dowolnej formie z zastrzeżeniem, że zgoda nie może być domniemana lub dorozumiana z oświadczenia woli
o innej treści. W przypadku złożenia przez zobowiązanego oferty zawarcia ugody bezpośrednio Zleceniodawcy, zobowiązuje się on do
niezwłocznego poinformowania o tym VOTUM.
		</p>
        <p>
4. Reklamacje związane z wykonaniem umowy Zleceniodawca może składać w formie listu poleconego na adres VOTUM. VOTUM
rozpatruje reklamacje i udziela Zleceniodawcy pisemnej odpowiedzi w terminie 14 dni.
		</p>
...
<div class="strona_znak_wodny"><?php echo $znak_wodny; ?></div>
	<div class="sekcja">
		...
		<div class="sekcja_tresc">
			...
			<p>
                W przypadku przekazania przez VOTUM świadczeń przekazem pocztowym, jego koszty obciążają Zleceniodawcę.
			</p>

            <p>
            2. <span class="pogrubienie">VOTUM nie pobiera wynagrodzenia</span> od uzyskanych dla Zleceniodawcy zwrotów kosztów leczenia, hospitalizacji, rehabilitacji,
dostosowania lokalu lub pojazdu do potrzeb osoby niepełnosprawnej, zakupu protez, sprzętów ortopedycznych, lekarstw, materiałów
opatrunkowych, jak również kosztów przejazdów Zleceniodawcy oraz osób bliskich do placówek medycznych.</p>
            <p>
            3. <span class="pogrubienie">VOTUM nie pobiera wynagrodzenia</span> od uzyskanych dla Zleceniodawcy rent, chyba że zobowiązany wypłaca je jednorazowo
w wysokości należnej za okres co najmniej 6 miesięcy.</p>
            <p>
           4. Zleceniodawca upoważnia VOTUM do odbioru wszelkich uzyskanych w jego imieniu świadczeń w ramach wykonania niniejszej umowy.</p>
            <p>
            5. Z tytułu wykonania niniejszej umowy VOTUM przysługuje wynagrodzenie w wysokości <?php echo $wysokosc_wynagrodzenia_procent; ?> %
(słownie: <?php echo $wysokosc_wynagrodzenia_procent_slownie; ?> procent) brutto wartości uzyskanych dla Zleceniodawcy
świadczeń (w tym podatek od towarów i usług VAT w wysokości 23 %).</p>
            <p>
            6. W przypadku spełnienia świadczenia przez zobowiązanego bezpośrednio do rąk Zleceniodawcy po dacie zawarcia niniejszej umowy,
...
należne VOTUM wynagrodzenie na rachunek bankowy prowadzony w ING Bank Śląski S.A. Oddział we Wrocławiu, nr 70 1050 1575 1000
0023 2392 0799 bądź w inny sposób wskazany przez VOTUM. W przypadku, gdy Zleceniodawca jest małoletni, ubezwłasnowolniony
częściowo lub całkowicie, albo też gdy jest reprezentowany przez swojego małżonka, przedstawiciel ustawowy, kurator lub opiekun,
albo małżonek Zleceniodawcy, zawierający umowę w jego imieniu, przyjmuje odpowiedzialność solidarną za zapłatę wynagrodzenia
i kosztów poniesionych przez VOTUM.</p>
        </div>
	</div>  
    ...
    <div class="sekcja">
		...
		<div class="sekcja_tresc">
		<p>
		W przypadku faktycznych bądź prawnych przeszkód w dochodzeniu roszczeń Zleceniodawcy, o których mowa w § 1, odmowy ich
zaspokojenia przez zobowiązanego albo odrzucenia bądź oddalenia w całości powództwa Zleceniodawcy o dochodzenie
tych roszczeń,<span class="pogrubienie">VOTUM zobowiązuje się nie dochodzić od Zleceniodawcy jakichkolwiek wynagrodzeń oraz zwrotu ponoszonych
kosztów,</span> w tym z tytułu analizy sprawy i jej prowadzenia na etapie przedsądowym i sądowym oraz kosztów reprezentacji
w postępowaniu karnym.
    ...
    <div class="sekcja">
		...
		<div class="sekcja_paragraf">§ 12</div>
		<div class="sekcja_tresc">
		<p>1. Wszelkie zmiany umowy wymagają formy pisemnej pod rygorem nieważności.</p>
        <p>2. W kwestiach nieuregulowanych mają zastosowanie przepisy kodeksu cywilnego.</p>
        <p>3. Umowę sporządzono i podpisano w dwóch jednobrzmiących egzemplarzach, po jednym dla każdej ze stron.</p>
        <p>4. Zleceniodawca upoważnia VOTUM do odbioru wszelkich uzyskanych w jego imieniu świadczeń w ramach wykonania niniejszej umowy.</p>
		</div>
	</div>
...
Wyrażam zgodę na przetwarzanie danych osobowych osoby, na rzecz której będą dochodzone roszczenia odszkodowawcze (w tym danych dotyczących stanu zdrowia, skazań, orzeczeń o ukaraniu
i mandatów karnych, a także innych orzeczeń wydanych w postępowaniu sądowym) w celu wykonania umowy.<br/><br/>

Wyrażam zgodę <span class="kratka"><?php echo $umowa['pcrf'] == 1 ? 'X' : '';  ?></span>/nie wyrażam zgody <span class="kratka"><?php echo $umowa['pcrf'] != 1 ? 'X' : '&nbsp';  ?></span> na przekazywanie PCRF Votum S.A. Sp. k. w Krakowie moich danych osobowych lub danych osobowych małoletniego / ubezwłasnowolnionego / małżonka,
którego reprezentuje, w tym informacji dotyczących stanu zdrowia, w celu opracowania i przedstawienia oferty indywidualnego programu rehabilitacji.”
	</div>
