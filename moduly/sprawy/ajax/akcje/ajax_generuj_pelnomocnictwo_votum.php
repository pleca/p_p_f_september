...
$adres_http_umowy = 'https://'.$_SERVER ['HTTP_HOST'].'/wzory_dokumentow/pelnomocnictwa/pelnomocnictwo_votum';
...
if (!$pdf->saveAs('/var/www/pliki/!sprawy/'.$id_sprawy.'/'.$id_sprawy.'_pelnomocnictwo_votum.pdf')) {
