...
?>
<link rel="stylesheet"
	href="<?php echo 'https://' . $_SERVER ['HTTP_HOST'] . '/wzory_dokumentow/css/umowa_prima.css'; ?>"
	type="text/css" />
<?php
// }
...
$numer_stopka = 'PG-2-1-F1/2017-01-26';
...
<div class="uo_strona">
		...
		<div class="uo_sekcja_tresc">
			<p>
				...
				Zleceniodawcy świadczeń należnych od zobowiązanego <span
					class="uo_pogrubienie">w postępowaniu przedsądowym.</span>
			</p>
		</div>
	</div>
	...
	<div class="uo_sekcja">
		...
		<div class="uo_sekcja_tresc">
			<p>
				1. Zleceniodawca upoważnia VOTUM do pozyskiwania informacji o jego stanie zdrowia w zakresie, w jakim jest to niezbędne do
                wykonania umowy.
			</p>
            <p>
                2. <span class="uo_pogrubienie">VOTUM oświadcza, że nie zawrze w imieniu Zleceniodawcy ugody ze zobowiązanym bez jego zgody. </span>
                Wyrażenie zgody może nastąpić
            ...
            <p>
                3. Reklamacje związane z wykonaniem umowy Zleceniodawca może składać w formie listu poleconego na adres VOTUM.
                VOTUM rozpatruje reklamacje i udziela Zleceniodawcy pisemnej odpowiedzi w terminie 30 dni.
            </p>
            <p>
                4. Informacje dotyczące wykonywania niniejszej umowy będą kierowane na wskazany przez Zleceniodawcę nr telefonu lub adres email,
...
<div class="uo_strona uo_strona_2">
	...
	<div class="uo_sekcja">
		<div class="uo_sekcja_tresc">
			<p>2. Zleceniodawca upoważnia VOTUM do odbioru wszelkich uzyskanych w jego imieniu świadczeń w ramach wykonania niniejszej umowy.</p>
			<p>
				3. Z tytułu wykonania niniejszej umowy VOTUM przysługuje wynagrodzenie w wysokości <?php echo $prowizja; ?> %
            ...
            <p>
                ...
                c) przekazu pocztowego, jeżeli Zleceniodawca nie podał numeru rachunku bankowego do spełnienia świadczenia,<br />
                d) określonej w przepisach prawa opłaty za postępowanie pozasądowe prowadzone przed Rzecznikiem Finansowym w wysokości
                50,00 zł, po uprzednim wyrażeniu zgody na takie postępowanie przez Zleceniodawcę,<br />
                e) określonej w przepisach prawa opłaty za mediację przed Sądem Polubownym przy Komisji Nadzoru Finansowego w wysokości
                50,00 zł, po uprzednim wyrażeniu zgody na takie postępowanie przez Zleceniodawcę.
            </p>
            <p>
                5. W przypadku spełnienia świadczenia przez zobowiązanego bezpośrednio do rąk Zleceniodawcy po dacie zawarcia niniejszej
                umowy, Zleceniodawca zobowiązuje się niezwłocznie powiadomić o tym VOTUM i wpłacić w terminie 7 dni roboczych od dnia jego
                otrzymania należne VOTUM wynagrodzenie na rachunek bankowy prowadzony w ING Bank Śląski S.A. Oddział we Wrocławiu, nr
                70 1050 1575 1000 0023 2392 0799 bądź w inny sposób wskazany przez VOTUM. W przypadku, gdy Zleceniodawca jest małoletni,
                ...
                kurator lub opiekun, albo małżonek Zleceniodawcy, zawierający umowę w jego imieniu, przyjmuje odpowiedzialność solidarną za
                zapłatę wynagrodzenia VOTUM.
            </p>
