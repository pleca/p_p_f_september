...
$stopka = 'PG-2-14-F9/2018-05-24';
//$stopka = 'PG-2-14-F9/2018-02-12';
$nr_strony = 1;
...
<div class="pdf_strona">
    <div class="pdf_strona_pierwsza_naglowek_bls">
        ...
        <div class="pdfs_tytul_dokumentu pdf_tytul_bls">
            ...
            <p class="margin_b_0 font_w_700 font_size_22 text_a_center">PRZELEWU WIERZYTELNOŚCI</p>
...
<div class="pdf_strona">
    ...
    <p class="margin_b_0">Cedent zbywa odpłatnie na rzecz Cesjonariusza wszelkie wierzytelności z tytułu <span class="font_w_700"><?php echo $umowa_dane['TytulOgraniczeniaWartosc']; ?></span>, przysługujące Cedentowi od Ubezpieczyciela: <span class="font_w_700"><?php echo $umowa_dane['UbezpieczycielNazwa']; ?></span>
        ...
        wierzytelności i zobowiązuje się do powzięcia czynności zmierzających do uzyskania od Dłużnika świadczeń z tytułu wierzytelności w imieniu własnym.</p>-->
    ...
    <p class="margin_b_0">1. Cesjonariusz nabywa od Cedenta wszelkie wierzytelności, o których mowa w § 1 za kwotę określoną w załączniku nr 1 do
        niniejszej umowy.</p>
    ...
    <p class="margin_b_0">3. Cesjonariusz zobowiązuje się do zapłaty kwoty określonej w załączniku nr 1 do niniejszej umowy w terminie 7 dni roboczych od daty podpisania umowy przez Cesjonariusza na rachunek bankowy wskazany przez Cedenta lub w inny sposób określony w załączniku nr 1 do
        niniejszej umowy.</p>
    ...
    <p class="margin_b_0">1. Cedent oświadcza, że łączna suma odszkodowania, jaką otrzymał w związku ze szkodą, o której mowa w § 1 wyniosła do dnia zawarcia umowy <span class="font_w_700"><?php echo $umowa_dane['OtrzymanaKwotaWierzytelności']; ?></span> zł brutto
        (słownie: <span class="font_w_700"><?php echo $umowa_dane['OtrzymanaKwotaWierzytelnościSlownie']; ?></span> złotych).</p>
    <p class="margin_b_0">2. Cedent oświadcza, że szkoda, o której mowa w § 1 miała miejsce w okolicznościach, o których zawiadomił ubezpieczyciela i nie toczyło się w związku z jej powstaniem postępowanie karne dotyczące doprowadzenia innej osoby do niekorzystnego rozporządzenia własnym lub cudzym mieniem za pomocą wprowadzenia jej w błąd (art. 286 kodeksu karnego) lub spowodowania zdarzenia będącego podstawą do wypłaty odszkodowania w celu uzyskania takiego odszkodowania z tytułu umowy ubezpieczenia (art. 298 kodeksu karnego).</p>
    <p class="margin_b_0">3.Cedent oświadcza, że koszty naprawy pojazdu wynikające ze szkody, o której mowa w § 1 nie zostały pokryte na podstawie przedstawienia Dłużnikowi rachunku, faktury VAT lub innego dokumentu potwierdzającego wysokość kosztów naprawy. Koszty, o których mowa
        w zdaniu pierwszym nie dotyczą holowania, najmu pojazdu zastępczego, parkowania, ani przedmiotów przewożonych w pojeździe,
        o którym mowa w § 1.</p>
        <p class="margin_b_0">4. Cedent oświadcza, że nie zrzekł się roszczeń przysługujących mu względem Dłużnika w związku ze szkodą, o której mowa w § 1, w tym
            w szczególności na podstawie ugody lub innego porozumienia.</p>
        <p class="margin_b_0">5. Cedent oświadcza, że wierzytelność, o której mowa w mowa w § 1 została zaspokojona wyłącznie w kwocie określonej w kosztorysie lub oświadczeniu ubezpieczyciela, które przekazał Cesjonariuszowi.</p>
        <p class="margin_b_0">6. Cedent oświadcza, że wszelkie wierzytelności określone w § 1, są wolne od obciążeń, oraz że uprawnienie do ich zbycia na rzecz osób trzecich nie zostało wyłączone.</p>
        ...
        <p class="margin_b_0">8. Cedent oświadcza, że ujawnił Cesjonariuszowi wszelkie nienaprawione uszkodzenia, jakie pojazd posiadał przed powstaniem szkody komunikacyjnej, o której mowa § 1. Ponadto Cedent oświadcza, że pojazd ten bezpośrednio przed powstaniem szkody był dopuszczony do ruchu po drogach publicznych, o ile nie złożył Cesjonariuszowi przed zawarciem umowy odmiennego oświadczenia w formie pisemnej albo nie
            przedłożył dokumentów stwierdzających okoliczności przeciwne.</p>
    ...
    <label class="pdf_duze_litery text_a_center col-md-12 margin_b_0 font_w_700 margin_t_20">DOKUMENTACJA DLA CESJONARIUSZA</label>
        ...
        <p class="margin_b_0">d) kosztorys wyceny szkody zawierający szczegółowy wykaz części podlegających wymianie lub naprawie, procedury naprawcze i czas ich
            wykonania oraz przyjęte ceny wyżej wymienionych, dla szkody, o której mowa w § 1 niniejszej umowy wykonany na zlecenie lub przez
            Dłużnika o którym mowa w § 1;</p>
    ...
    <div class="pdf_strona">
        ...
        <p class="margin_b_0">e) wszelkie oświadczenia Dłużnika o przyznaniu odszkodowania z tytułu szkody o której mowa w § 1 lub potwierdzenie wpływu odszkodowania
            na rachunek bankowy Cedenta bądź pokwitowanie jego odbioru;</p>
        <p class="margin_b_0">f) w przypadku gdy wierzytelności przysługują Cedentowi z tytułu ubezpieczenia AUTO-CASCO – kopię polisy oraz ogólnych warunków
            umowy ubezpieczenia aktualnych na dzień zawarcia umowy.</p>
        ...
        <p class="margin_b_0">2. Niniejsza umowa wraz z załącznikiem nr 1 została sporządzona w dwóch jednobrzmiących egzemplarzach, po jednym dla każdej ze Stron.</p>
        <p class="margin_b_0">3. Integralną częścią niniejszej umowy jest załącznik – Klauzula informacyjne dla Klienta.</p>
