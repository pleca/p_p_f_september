...
$DataDecyzji = $odpowiedzialnosc_cywilna_tmp->DataDecyzji;
...
?>
        <div class="daneStronyUmowyPopUp">
            ...
            <label class="margin_t_10 width_100">Czy wypłacono odszkodowanie z OC sprawcy?</label>
            ...
            <label class="margin_t_10 width_100">Wypłacone odszkodowanie dotyczyło?</label>
            <div class="zaznaczPoleGrupa ">
            ...
            <div class="zaznaczPoleGrupa SzkodaOsobowa">
                ...
                <div class="zpg_opcja zpg_opcja_input"><p class="float_l">w kwocie:</p><input type="text" data-wartosc_domyslna="<?php echo $KwotaOdszkodowania; ?>" value="<?php echo ($SzkodaOsobowa == 1) ? $KwotaOdszkodowania : ''; ?>" data-kolumna="KwotaOdszkodowania" maxlength="10" class="update"/> zł </div>
                <div class="zaznaczPoleGrupa ">
                    <div class="zpg_opcja_radio margin_l_40"><p class="float_l">na podstawie: </p><i data-wartosc_domyslna="<?php echo $PodstawaPrawna; ?>" value="1" data-kolumna="PodstawaPrawna" class="fa fa<?php echo ($SzkodaOsobowa == 1 && $PodstawaPrawna == 1) ? '-check' : '' ; ?>-square-o fa-2 float_l attrValue" aria-hidden="true"></i><p class="float_l">ugody </p></div>
                    <div class="zpg_opcja_radio float_l"><i data-wartosc_domyslna="<?php echo $PodstawaPrawna; ?>" value="2" data-kolumna="PodstawaPrawna" class="fa fa<?php echo ($SzkodaOsobowa == 1 && $PodstawaPrawna == 2) ? '-check' : '' ; ?>-square-o fa-2 float_l attrValue" aria-hidden="true"></i><p class="float_l">wyroku </p></div>
                    <div class="zpg_opcja_radio float_l"><i data-wartosc_domyslna="<?php echo $PodstawaPrawna; ?>" value="3" data-kolumna="PodstawaPrawna" class="fa fa<?php echo ($SzkodaOsobowa == 1 && $PodstawaPrawna == 3) ? '-check' : '' ; ?>-square-o fa-2 float_l attrValue" aria-hidden="true"></i><p class="float_l">decyzji z dnia: </p></div>
                    <div class="zpg_opcja zpg_opcja_input float_l"><input type="text" data-wartosc_domyslna="<?php echo $DataDecyzji; ?>" value="<?php echo ($SzkodaOsobowa == 1 && $PodstawaPrawna == 3) ? $DataDecyzji : ''; ?>" data-kolumna="DataDecyzji" maxlength="10" class="update datePicker"/></div>
                    <div class="zpg_opcja_radio float_l"><i data-wartosc_domyslna="<?php echo $PodstawaPrawna; ?>" value="4" data-kolumna="PodstawaPrawna" class="fa fa<?php echo ($SzkodaOsobowa == 1 && $PodstawaPrawna == 4) ? '-check' : '' ; ?>-square-o fa-2 float_l attrValue" aria-hidden="true"></i><p class="float_l">nie wiem </p></div>
                </div>
                <div class="clear_b"></div>
            </div>

            <button data-reakcja="<?php echo ($akcja == 'nowy') ? 'zapisz_zmiany' : 'zapisz_przeladuj_widok'; ?>" data-droga="<?php echo $droga; ?>" data-klasa_rodzic="daneStronyUmowyPopUp" data-element_id="<?php echo $element_id; ?>" data-tabela="OdpowiedzialnoscCywilna" data-ogolne="0" data-strona="7" data-akcja="<?php echo (!$odpowiedzialnosc_cywilna_tmp) ? 'dodaj_odpowiedzialnosc_cywilna' : 'aktualizuj_odpowiedzialnosc_cywilna'; ?>" type="button" class="przyciskZapiszZmianyZielony margin_t_10 wczytajStroneDrogiUmowyDoPopUp btn btn-success width_100 margin_b_0">Zapisz zmiany</button>
        </div>
