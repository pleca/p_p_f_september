...
?>
        <div class="daneStronyUmowyPopUp">
            ...
            <div class="zaznaczPoleGrupa ZleconoRoszczenia ">
                ...
                <div class="zpg_opcja zpg_opcja_input float_l"><p class="float_l">data zawarcia umowy:</p><input type="text" data-wartosc_domyslna="<?php echo $DataZawarciaUmowy; ?>" value="<?php echo ($ZleconoRoszczenia == 2) ? $DataZawarciaUmowy : ''; ?>" data-kolumna="DataZawarciaUmowy" maxlength="10" class="datePicker update"/></div>
                <div class="clear_b"></div>
            </div>

            <label class="margin_t_10 width_100">Czy wypowiedziano umowę z wyżej wymieninym pełnomocnikiem?</label>
            <div class="zaznaczPoleGrupa WypowiedzenieUmowy ">
                <div class="zpg_opcja_radio float_l"><i data-wartosc_domyslna="<?php echo $CzyZgloszonoRoszczenie; ?>" value="1" data-kolumna="WypowiedzenieUmowy" class="fa fa<?php echo ($WypowiedzenieUmowy == 1) ? '-check' : '' ; ?>-square-o fa-2 float_l attrValue WypowiedzenieUmowyTak" aria-hidden="true"></i><p class="float_l">TAK, </p></div>
                <div class="zpg_opcja zpg_opcja_input float_l"><p class="float_l">data wypowiedzenia:</p><input type="text" data-wartosc_domyslna="<?php echo $DataWypowiedzenia; ?>" value="<?php echo ($WypowiedzenieUmowy == 1) ? $DataWypowiedzenia : ''; ?>" data-kolumna="DataWypowiedzenia" maxlength="10" class="datePicker update"/></div>
                <div class="zpg_opcja_radio float_l"><i data-wartosc_domyslna="<?php echo $CzyZgloszonoRoszczenie; ?>" value="2" data-kolumna="WypowiedzenieUmowy" class="fa fa<?php echo ($WypowiedzenieUmowy == 2) ? '-check' : '' ; ?>-square-o fa-2 float_l attrValue WypowiedzenieUmowyNie" aria-hidden="true"></i><p class="float_l">NIE</p></div>
                <div class="clear_b"></div>
            </div>
