...
<?php echo $znak_wodny; ?>
	...
	<div class="up_zleceniodawca">
		...
		<div class="up_element">
			<p>IMIĘ</p>
			<div class="up_zleceniodawca_w_imieniu_imie margin_r_20"><?php echo ($w_imieniu == 0) ? '' : $w_imieniu_imie; ?>&nbsp;</div>
		</div>
		<div class="up_element">
			<p>NAZWISKO</p>
			<div class="up_zleceniodawca_w_imieniu_nazwisko"><?php echo ($w_imieniu == 0) ? '' : $w_imieniu_nazwisko; ?>&nbsp;</div>
		</div>

		<div class="clear_b"></div>
		<div class="up_element">
			<p>ULICA</p>
			<div class="up_zleceniodawca_w_imieniu_ulica margin_r_20"><?php echo ($w_imieniu == 0) ? '' : $w_imieniu_ulica; ?>&nbsp;</div>
		</div>
		<div class="up_element">
			<p>NR DOMU</p>
			<div class="up_zleceniodawca_w_imieniu_nr_domu "><?php echo ($w_imieniu == 0) ? '' : $w_imieniu_dom; ?>&nbsp;</div>
		</div>
		<div class="up_element">
			<p>NR MIESZKANIA</p>
			<div class="up_zleceniodawca_w_imieniu_nr_mieszkania margin_r_20"><?php echo ($w_imieniu == 0) ? '' : $w_imieniu_mieszkanie; ?>&nbsp;</div>
		</div>
		<div class="up_element">
			<p>KOD POCZTOWY</p>
			<div class="up_zleceniodawca_w_imieniu_kod_pocztowy margin_r_20"><?php echo ($w_imieniu == 0) ? '' : $w_imieniu_kod; ?>&nbsp;</div>
		</div>
		<div class="up_element">
			<p>MIEJSCOWOŚĆ</p>
			<div class="up_zleceniodawca_w_imieniu_miejscowosc"><?php echo ($w_imieniu == 0) ? '' : $w_imieniu_miejscowosc; ?>&nbsp;</div>
		</div>
		<div class="clear_b"></div>
	</div>
	...
	<div class="up_sekcja">
		...
		<div class="up_sekcja_tresc">
			<p>
				...
				cywilną w związku z wypadkiem z dnia <span class="up_pogrubienie"><?php echo $data_wypadku; ?></span>
	...
	<div class="up_sekcja">
		...
		<div class="up_sekcja_tresc">
			...
			<p>6. Koszty procesu poniesione przez Votum podlegają zwrotowi na rzecz VOTUM
                wyłącznie z kwoty ogółu świadczeń przyznanych Zleceniodawcy rozstrzygnięciem
                sądu lub ugodą, a koszty zastępstwa procesowego zasądzone w sprawie przypadają
	...
	<div class="up_sekcja">
		...
		<div class="up_sekcja_tresc">
			<p class="margin_b_10">
				...
				wynagrodzenia <span class="up_kratka"><?php echo $platnosc == '0' ? 'X' : '&nbsp';  ?></span>przekazem
				pocztowym / <span class="up_kratka"><?php echo $platnosc != '0' ? 'X' : '&nbsp';  ?></span>na
			...
			<div class="up_element up_kratka_element">
				<span class="up_kratka"><?php echo $osoba_do_wyplaty == $zleceniodawca_id ? 'X' : '&nbsp&nbsp';  ?></span>
			...
			<p>
            5. Z tytułu wykonania niniejszej umowy VOTUM przysługuje wynagrodzenie w wysokości <?php echo $prowizja; ?> %
(słownie: <?php echo slownie($prowizja); ?> procent) brutto wartości uzyskanych dla Zleceniodawcy
świadczeń (w tym podatek od towarów i usług VAT w wysokości 23 %).</p>
	...
	<div class="up_objasnienia up_strona_3 uo_sekcja">
		...
		umowy.<br /> <br /> Wyrażam zgodę <span class="up_kratka"><?php echo $inne_odszkodowania['pcrf'] == 1 ? 'X' : '&nbsp';  ?></span>/nie
		wyrażam zgody <span class="up_kratka"><?php echo $inne_odszkodowania['pcrf'] != 1 ? 'X' : '&nbsp';  ?></span>
		na przekazywanie PCRF Votum S.A. Sp. k. w Krakowie moich danych
		osobowych lub danych osobowych małoletniego / ubezwłasnowolnionego /
		małżonka, którego reprezentuje, w tym informacji dotyczących stanu
		zdrowia, w celu opracowania i przedstawienia oferty indywidualnego
