...
$stopka = 'PG-2-19-F6/2018-05-24';
//$stopka = 'PG-2-19-F6/2018-02-07';
$nr_strony = 1;
...
<div class="pdf_strona">
    <div class="pdf_strona_pierwsza_naglowek_bls">
        ...
        <div class="pdfs_tytul_dokumentu pdf_tytul_bls">
            ...
            <p class="margin_b_0 font_w_700 font_size_22 text_a_center">POWIERNICZEGO PRZELEWU WIERZYTELNOŚCI BLS</p>
...
<div class="pdf_strona">
    ...
    <p class="margin_b_0">Cedent zbywa odpłatnie na rzecz Cesjonariusza wszelkie wierzytelności z tytułu <span class="font_w_700"><?php echo $umowa_dane['TytulOgraniczeniaWartosc']; ?></span>, przysługujące Cedentowi od Ubezpieczyciela: <span class="font_w_700"><?php echo $umowa_dane['UbezpieczycielNazwa']; ?></span>
        ...
        a Cesjonariusz przyjmuje wierzytelności i zobowiązuje się do podjęcia czynności zmierzających do uzyskania od dłużnika świadczeń z tytułu wierzytelności w imieniu własnym, lecz na rachunek Cedenta.
    </p>
    <!--<p class="margin_b_0">Cedent zbywa odpłatnie na rzecz Cesjonariusza wszelkie wierzytelności jakie przysługują Cedentowi z tytułu odszkodowania za szkodę w pojeździe marki
        ...
        <?php /*echo $umowa['DataUmowy']; */?> w sprawie o numerze <?php /*echo $umowa['NumerSprawy']; */?>. Cesjonariusz oświadcza iż przyjmuje wierzytelność i zobowiązuje się do powzięcia czynności zmierzających do uzyskania od <?php /*echo $umowa_dane['UbezpieczycielNazwa']; */?>
        świadczeń z tytułu wierzytelności w imieniu własnym, lecz na rachunek Cedenta.
    </p>-->
    ...
    <p class="margin_b_0">1. Za wykonanie czynności powierniczych Cesjonariusz otrzyma wynagrodzenie w postaci prowizji od uzyskanych na rachunek Cedenta świadczeń,
        której wysokość i sposób zapłaty określa załącznik nr 1 do niniejszej umowy.</p>
    ...
    <p class="margin_b_0">3. Cesjonariusz zobowiązuje się do przekazania na rzecz Cedenta kwoty uzyskanej od Dłużnika po potrąceniu prowizji, o której mowa w ust. 1 , w terminie 7 dni roboczych od daty uzyskania należności od dłużnika, na rachunek bankowy wskazany przez Cedenta lub
    ...
    <?php } ?>
        ...
        <p class="margin_b_0">3. Cedent oświadcza, że szkoda, o której mowa w § 1, miała miejsce w okolicznościach, o których zawiadomił ubezpieczyciela, oraz że nie toczyło się w związku z jej powstaniem postępowanie karne dotyczące doprowadzenia innej osoby do niekorzystnego rozporządzenia własnym lub cudzym mieniem za pomocą wprowadzenia jej w błąd (art. 286 kodeksu karnego)
            lub spowodowania zdarzenia będącego podstawą do wypłaty odszkodowania w celu uzyskania takiego odszkodowania z tytułu umowy ubezpieczenia (art. 298 kodeksu karnego).</p>
        <p class="margin_b_0">4. Cedent oświadcza, że koszty naprawy pojazdu w związku ze szkodą, o której mowa w 51, nie zostały pokryte na podstawie przedstawienia Dłużnikowi rachunku lub faktury VAT lub innego dokumentu potwierdzającego wysokość kosztów naprawy. Koszty, o których mowa w zdaniu pierwszym, nie dotyczą holowania, najmu pojazdu zastępczego, parkowania, ani przedmiotów przewożonych w pojeździe, o którym mowa w § 1.</p>
        ...
        <p class="margin_b_0">8. Cedent oświadcza, że ujawnił Cesjonariuszowi wszelkie nienaprawione uszkodzenia, jakie pojazd posiadał przed powstaniem szkody komunikacyjnej, o której mowa § 1. Ponadto Cedent oświadcza, że pojazd ten bezpośrednio przed powstaniem szkody był dopuszczony do ruchu po drogach publicznych, o ile nie złożył Cesjonariuszowi przed zawarciem urnowy odmiennego oświadczenia w formie pisemnej albo nie przedłożył dokumentów stwierdzających okoliczności przeciwne.</p>
        ...
        <p class="margin_b_0">11. W przypadku uzyskania przez Cedenta od Dłużnika świadczenia tytułem spłaty wierzytelności, określonej w § 1, po podpisaniu przez
            Cedenta niniejszej umowy, Cedent zobowiązuje się do przekazania całości honorarium w wysokości, wynikającego z §1 ust. 1 Załącznika nr 1 do umowy powierniczego przelewu wierzytelności na rachunek bankowy Cesjonariusza ING Bank Śląski S.A. 16 1050 1575 1000 0090 3092 6340 oraz powiadomić o tym Cesjonariusza na piśmie w terminie 7 dni roboczych od daty uzyskania świadczenia.</p>
    <?php if (($i%2)==1) { ?>
        <div class="pdf_strona_stopka col-md-12 margin_b_0">
            <div class="pdf_strona_stopka_wersja"><?php echo $stopka; ?></div>
            <p class="text_a_center margin_b_0"><?php echo $nr_strony++; ?>/<?php echo $strony; ?></div></p>
    ...
    <label class="pdf_duze_litery text_a_center col-md-12 margin_b_0 font_w_700 margin_t_20">PRAWA I OBOWIĄZKI STRON</label>
        ...
        <p class="margin_b_0">d) kosztorys wyceny szkody zawierający szczegółowy wykaz części podlegających wymianie lub naprawie, procedury naprawcze
            i czas ich wykonania oraz przyjęte ceny wyżej wymienionych, dla szkody, o której mowa w § 1 niniejszej umowy wykonany na zlecenie lub przez Dłużnika o którym mowa w § 1;</p>
        ...
        <p class="margin_b_0">3. Cesjonariusz może wykonywać czynności wchodzące w zakres umowy za pomocą podmiotów współpracujących, w szczególności adwokatów lub radców prawnych, przy czym za działanie tych osób Cesjonariusz odpowiada wobec Cedenta, jak za działania własne.</p>
        ...
        <p class="margin_b_0">1. Umowa zostaje zawarta na czas do całkowitego wyegzekwowania przez Cesjonariusza roszczeń dochodzonych na rachunek Cedenta w postępowaniu przedsądowym, sądowym i egzekucyjnym.</p>
        <p class="margin_b_0">2. W przypadku rozwiązania bądź wypowiedzenia umowy przed całkowitym wyegzekwowaniem roszczeń Cesjonariusz dokona na rzecz Cedenta w terminie 7 dni cesji zwrotnej wierzytelności w części, w której nie została zaspokojona w wykonaniu umowy.</p>
    ...
    <?php } ?>
        ...
        <div class="pdf_podpisy col-md-12 paddding_l_0 paddding_r_0 margin_t_60 margin_b_20">
            ...
            <div class="pdf_podpisy_p float_r col-md-6 paddding_l_0 paddding_r_0">
                <div class="pdf_kreska col-md-12 paddding_l_0 paddding_r_0 margin_b_0"></div>
                <p class="margin_b_0 font_size_10 pdf_duze_litery text_a_right">CEDENT <span class="font_size_8">(OSOBY DOKONUJĄCE CESJI CESJI POWIERNICZEJ)</span></p>
            </div>
            <div class="clear_b"></div>
        </div>
...
<!--        <p class="margin_b_0 font_size_10">3. dane osobowe mogą być przekazywane podmiotom współpracującym przy jej wykonaniu, jak również podmiotom, od których będą uzyskiwane informacje niezbędne do wykonania umowy i podmiotom, od których będą dochodzone roszczenia,</p>-->
