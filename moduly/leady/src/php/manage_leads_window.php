...
<script id="manageTemplate" type="text/x-kendo-template">
    ...
    <ul class="fieldlist">
        ...
        <li>
            ...
            <div id="comment_list">
                <div id="comments_grid" data-role="grid"
                        data-filterable="false"
                        data-editable="{'mode': 'inline'}"
                        data-toolbar="['create', {'name':'save', 'className': 'refresh-grid'}]"
                        data-columns="[
                                        { 'field': 'CommentDate', 'title': 'Data komentarza', 'width': 120},
                                        { 'field': 'Comment', 'title': 'Komentarz' },
                                        { 'field': 'UserLogin', 'title': 'Użytkownik' },
                                        { 'command': [{'text':'Pokaż','name':'show_map', 'click': showMap, 'iconClass':'k-icon k-i-marker-pin', 'className': 'btn-show'}], 'width': '100px'}
                                       ]"
                        ...
                        schema: {
                            model: {
                                ...
                                fields: {
                                    ...
                                    Latitude: { type: "string", editable: false },
        ...
        <li>
                <div id="map"></div>
                <div class="alert_map"><label for="simple-textarea">Przedstawiona lokalizacja jest poglądowa i może się różnić od rzeczywistej.</label></div>
                <script src="https://maps.google.com/maps/api/js?key=AIzaSyCa3aKZeoITAqNofRT7odMmH1CBk38eDXo"><\/script>
        </li>
        <li>
            <label for="simple-textarea">Historia</label>
            <div id="history_list">
                <div data-role="grid"
                        data-filterable="false"
                        data-editable="false"
                        data-columns="[
                                        { 'field': 'Date', 'title': 'Data', 'width': 120},
                                        { 'field': 'ChangedObject', 'title': 'Pole' },
                                        { 'field': 'ValueBefore', 'title': 'Przed' },
                                        { 'field': 'ValueAfter', 'title': 'Po' },
                                        { 'field': 'UserLogin', 'title': 'Użytkownik' }
                                      ]"
            ...
            <script>
                    ...
                    history: new kendo.data.DataSource({
                        schema: {
                            model: {
                                ...
                                fields: {
                                    Date: { type: "string" },
                                    ChangedObject: { type: "string" },
                                    UserLogin: { type: "string" },
                                    ValueBefore: { type: "string" },
                                    ValueAfter: { type: "string" }
                                }
                            }
                        },
                        batch: true,
                ...
                kendo.bind($("\#history_list"), viewModel);
            <\/script>
        </li>
                #if(przypisz_agenta){#
                <li>
