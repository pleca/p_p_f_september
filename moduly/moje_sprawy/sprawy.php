...
?>
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-10">
            <div class="panel panel-default">
                <table id="sprawy" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead>
                    <tr>
                        <th></th>
                        <th>Numer sprawy</th>
                        <th>Data wpływu</th>
                        <th>Data ostatniego wpływu</th>
                        <th>Data ostatniego komentarza</th>
                        <th>Nazwisko i imię klienta</th>
