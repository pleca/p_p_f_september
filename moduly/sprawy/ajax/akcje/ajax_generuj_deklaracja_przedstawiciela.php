...
$adres_http_umowy = 'https://'.$_SERVER ['HTTP_HOST'].'/wzory_dokumentow/deklaracje/deklaracja_przedstawiciela';
...
if (!$pdf->saveAs('/var/www/pliki/!sprawy/'.$id_sprawy.'/'.$id_sprawy.'_deklaracja_przedstawiciela.pdf')) {
