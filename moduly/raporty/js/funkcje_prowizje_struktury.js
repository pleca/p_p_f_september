...
//
//     $('#strona').on('click','#sprzedaz_struktury',function(){
//         $('#podzial_prowizji_agenta').hide();
...
//         columnDefs: [
//             { responsivePriority: 1, targets: dane_do_tabeli_pobierz_sume_prowizji_agentow_ostatni_miesiac (rok)+1},
//             { responsivePriority: 2, targets: dane_do_tabeli_pobierz_sume_prowizji_agentow_ostatni_miesiac (rok)},
//             { responsivePriority: 1, targets: dane_do_tabeli_pobierz_sume_prowizji_agentow_ostatni_miesiac (rok)-2}
//         ],
//         language: {
