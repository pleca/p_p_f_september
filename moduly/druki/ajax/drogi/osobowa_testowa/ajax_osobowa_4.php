...
?>
        <div class="daneOZdarzeniuPopUp">
            ...
            <label class="margin_t_10 width_100">Data i miejsce zdarzenia</label>
            ...
            <div class="clear_b"></div>
            <div class="col-md-6 inputPole padding_r_10 margin_t_10 "><input data-wartosc_domyslna="<?php echo $KrajRejestracjiA; ?>" value="<?php echo $KrajRejestracjiA; ?>" data-kolumna="KrajRejestracjiA" type="text" class="update duzeMaleLiteryCyfry" placeholder="Kraj rejestracji pojazdy"></div>
            ...
            <div class="clear_b"></div>
            <div class="col-md-6 inputPole padding_r_10 margin_t_10 "><input data-wartosc_domyslna="<?php echo $KrajRejestracjiB; ?>" value="<?php echo $KrajRejestracjiB; ?>" data-kolumna="KrajRejestracjiB" type="text" class="update duzeMaleLiteryCyfry" placeholder="Kraj rejestracji pojazdy"></div>
