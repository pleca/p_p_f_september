...
$zleceniodawca_wiek = $zleceniodawca ['wiek'];
...
$poszkodowany_wiek = $poszkodowany ['wiek'];
...
$wiek_do_oswiadczenia = ($sprawa['sprawa_uprawniony_id'] == 'NULL') ? $zleceniodawca['wiek'] : $uprawniony ['wiek'];
...
//$zdarzenie_data = date("h:i", $zdarzenie ['data']);
//echo "The time is " . date("h:i:sa");
//$zdarzenie_godzina = date("h:i",$zdarzenie ['godzina']);
$zdarzenie_godzina = date('G:i', strtotime($zdarzenie ['godzina']));
//date("h:i", $zdarzenie ['data']);
...
<div class="strona strona_4">
	...
	<div class="formularz">
		...
		<div class="tresc_sekcji_fomularza">
			...
			<div class="element">
				<p>WIEK</p>
				<div class="zleceniodawca_wiek"><?php echo $wiek_zleceniodawcy; ?>&nbsp;</div>
			</div>
			<div class="clear_b"></div>
		...
		<div class="tresc_sekcji_fomularza">
			...
			<div class="element">
				<p>WIEK</p>
				<div class="zleceniodawca_wiek"><?php echo ($zleceniodawca['id'] == $poszkodowany['id']) ? ' ' : $wiek_poszkodowanego; ?>&nbsp;</div>
			</div>
			<div class="clear_b"></div>
			<div class="element">
				<p>ULICA</p>
...
<?php echo $znak_wodny; ?>
	<div class="formularz_szary margin_b_10">
		...
		<div class="tresc_sekcji_fomularza">
            ...
            <div class="element"><?php echo $i.'. '.$hospitalizacja_dane['nazwa'].''; ?> <?php echo ' '.$hospitalizacja_dane['data'].' - '.$hospitalizacja_dane['data_do']; ?></div>
			<div class="clear_b"></div>
...
<?php echo $znak_wodny; ?>
	...
	<div class="formularz_szary">
		...
		<div class="tresc_sekcji_fomularza">
			...
			<div class="element">
				W momencie śmierci zmarłego/-ej miałem/am <b><?php echo ($sprawa['sprawa_typ_szkody_id'] == '2') ? $wiek_do_oswiadczenia : '__________'; ?></b>.
				Wykształcenie
			</div>
			<div class="element">
		...
		<div class="tresc_sekcji_fomularza">
			...
			<div class="element">
				<div class="kratka"><?php echo (($sytuacja_rodziny['czy_zostal_malzonek']=='1') AND ($sprawa['sprawa_typ_szkody_id'] == '2')) ? 'X' : ''; ?></div>
				wdowca
			</div>
			<div class="element">
				<div class="kratka"><?php echo (($sytuacja_rodziny['czy_zostal_malzonek']=='2') AND ($sprawa['sprawa_typ_szkody_id'] == '2')) ? 'X' : ''; ?></div>
				wdowę
			</div>
			<div class="element">
