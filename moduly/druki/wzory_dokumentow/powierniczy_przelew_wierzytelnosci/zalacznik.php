...
<?php for ($i=1; $i<=$liczba_wlascicieli; $i++ ) { ?>
    ...
    <div class="pdf_strona">
        <div class="pdf_strona_pierwsza_naglowek">
            ...
            <div class="pdfs_tytu_dokumentu pdf_tytul_cesja">
                ...
                <p class="margin_b_0 font_w_700 font_size_26 text_a_center">UMOWY POWIERNICZEGO PRZELEWU</p>
                <p class="margin_b_0 font_w_700 font_size_26 text_a_center">WIERZYTELNOŚCI "A" NR: </p>
            </div>
        ...
        <p class="margin_b_0">1. Wynagrodzenie Cesjonariusza brutto przewidziane w §2 ust.1 Umowy stanowi <span class="font_w_700"><?php echo $umowa_dane['WysokoscHonorarium']; ?></span> % (słownie: <span class="font_w_700"><?php echo $umowa_dane['WysokoscHonorariumSlownie']; ?> </span>
            procent) kwoty brutto (w tym podatek od towarów i usług VAT w wysokości 23%) uzyskanej
            przez Cesjonariusza z tytułu wierzytelności przysługujących od Dłużnika.</p>
        <p class="margin_b_0">2. Cesjonariusz zobowiązuje się do przekazania na rzecz Cedenta uzyskanych świadczeń w terminie 7 dni roboczych od dnia ich otrzymania,
            po uprzednim potrąceniu należnego VOTUM wynagrodzenia:</p>
    ...
    <div class="pdf_strona">
        ...
        <p class="margin_b_0">Załącznik stanowi integralną część umowy.</p>
